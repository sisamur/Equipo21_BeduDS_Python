...
Este repositorio tiene como objeto, el ser utilizado para subir la evidencia correspondiente a los postwork realizados y al proyecto, desarrollado durante la **Fase 2** del módulo de Python del curso de **Data Science** impartido por **Bedu** y **Santander**.
